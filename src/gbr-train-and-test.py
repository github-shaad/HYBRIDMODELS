...
param_grid = {
         'n_estimators': [200, 100],             # Number of boosting stages (trees)
        'learning_rate': [0.1, 0.5, 0.05],     # Step size shrinkage
        'max_depth': [5, 7],                   # Maximum depth of individual trees
        'min_samples_split': [5, 3],             # Min samples required to split an internal node
